...
var app = express();
var PORT = 3000;
var db = require('./models/db.js'); // Path to your central Sequelize file (db.js)
...
function testClasses() {
  return _testClasses.apply(this, arguments);
}
function _testClasses() {
  _testClasses = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var hashedPassword, newCompany, newGood, newType, newDepartment, newSupplier, newSubscription, newAddress, parentType, subType1, subType2;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          // Test Company
          hashedPassword = db.Company.prototype.generateHash('password123'); //Don't forget to add the Hash during register
        ...
        case 5:
          ...
          // Test Good
          _context.next = 9;
          return db.Good.create({
            label: 'Example Good',
            quantity: 10,
            priceHT: 29.99
          });
        case 9:
          newGood = _context.sent;
        ...
        case 45:
          ...
          console.error('Error testing classes:', _context.t0);
        case 48:
        case "end":
...
app.listen(PORT, function () {
  console.log("Serveur d\xE9marr\xE9 sur http://localhost:".concat(PORT));
});
